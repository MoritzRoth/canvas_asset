...
#define CANVAS_TEX g_Texture0

uniform sampler2D g_Texture1; // {"hidden":true}
#define INFLUENCE_TEX g_Texture1

uniform sampler2D g_Texture2; // {"hidden":true}
#define RESET_TEX g_Texture2
...
//   2. Brush Preview [WILL MAYBE ADD IN THE FUTURE]
...
void main() {
	vec4 canvas = texSample2D(CANVAS_TEX, v_TexCoord);
